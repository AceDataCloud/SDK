/** AI Chat resources — aichat/conversations and aichat2/conversations endpoints. */
...
export class AiChat2 {
  ...
  async create(opts: {
    ...
    const {
      ...
      maxTurns, async: asyncMode, callbackUrl, allowedSkills, allowedMcpServers,
      unattendedPolicy, toolResults, messages, title, userId, applicationId,
