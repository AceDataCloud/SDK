...
export type AiChat2MessagePart = {
  type?: 'text' | 'image_url' | 'file_url';
  text?: string;
  image_url?: { url?: string };
  file_url?: { url?: string };
};
export type AiChat2Message = string | AiChat2MessagePart[];
export type AiChat2ToolResult = {
  tool_use_id: string;
  output: string;
  is_error?: boolean;
};
export type AiChat2UnattendedPolicy = {
...
export interface AiChat2CreateOptions {
  model: AiChat2Model;
  action?: AiChat2Action;
  id?: string;
  question?: string;
  message?: AiChat2Message;
  stateful?: boolean;
  references?: string[];
  preset?: string;
  max_turns?: number;
  ...
  allowed_skills?: string[];
  allowed_mcp_servers?: string[];
  unattended_policy?: AiChat2UnattendedPolicy;
  tool_results?: AiChat2ToolResult[];
...
export class AiChat2 {
  ...
  async create(opts: AiChat2CreateOptions): Promise<Record<string, unknown>> {
