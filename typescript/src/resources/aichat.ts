...
type AiChatAction = 'chat' | 'retrieve' | 'retrieve_batch' | 'update' | 'delete';

type AiChatModelGroup = 'chatgpt' | 'claude' | 'gemini' | 'grok' | 'kimi' | 'glm' | 'deepseek';
