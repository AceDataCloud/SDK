...
class DrawAI:
    """Synchronous DrawAI headshot client."""
    ...
    def generate(
        self,
        *,
        template: HeadshotTemplate | str,
        mode: Literal["fast", "relax"] = "fast",
        image_urls: list[str],
        ...
        **kwargs: Any,
        ...
        body: dict[str, Any] = {"template": template, "mode": mode, "image_urls": image_urls, **kwargs}
        ...
        handle = TaskHandle(task_id, "/headshots/tasks", self._transport)
        if wait:
...
class AsyncDrawAI:
    ...
    async def generate(
        ...
        **kwargs: Any,
        ...
        handle = AsyncTaskHandle(task_id, "/headshots/tasks", self._transport)
        if wait:
