...
class _Recognition:
    ...
    def image2text(self, *, image: str, async_: bool | None = None, **kwargs: Any) -> dict[str, Any]:
    ...
    def recaptcha2(
        self, *, image: str, question: str, async_: bool | None = None, **kwargs: Any
    ) -> dict[str, Any]:
...
class _AsyncRecognition:
    ...
    async def image2text(self, *, image: str, async_: bool | None = None, **kwargs: Any) -> dict[str, Any]:
        body: dict[str, Any] = {"image": image, **kwargs}
        if async_ is not None:
            body["async"] = async_
