...
class Images:
    ...
    def generate(
        ...
        *,
        ...
        size: Literal["1K", "2K", "3K", "4K", "adaptive"] | str | None = None,
        seed: int | None = None,
        guidance_scale: float | None = None,
        response_format: str | None = None,
        watermark: bool | None = None,
        output_format: Literal["jpeg", "png"] | str | None = None,
        stream: bool | None = None,
        sequential_image_generation: Literal["auto", "disabled"] | str | None = None,
