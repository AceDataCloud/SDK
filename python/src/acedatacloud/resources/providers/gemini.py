...
GeminiAspectRatio = Literal["16:9", "9:16"]
GeminiResolution = Literal["720p", "1080p"]
...
class _GeminiChat:
    ...
    @property
    def completions(self) -> _GeminiChatCompletions:
        return _GeminiChatCompletions(self._transport)
...
class _GeminiChatCompletions:
    ...
    def create(
        ...
        **extra: Any,
        ...
        """Gemini chat completions. Supports streaming."""
...
class _GeminiVideos:
    ...
    def generate(
        ...
        *,
        ...
        aspect_ratio: GeminiAspectRatio | None = None,
...
class Gemini:
    ...
    def stream_generate_content(
        ...
        **extra: Any,
        ...
        """Gemini native streaming generate content API."""
        body: dict[str, Any] = {"contents": contents}
        if system_instruction is not None:
            body["systemInstruction"] = system_instruction
        if generation_config is not None:
        ...
        if cached_content is not None:
            body["cachedContent"] = cached_content
        body.update(extra)
        return self._transport.request("POST", f"/v1beta/models/{model}:streamGenerateContent", json=body)
...
class _AsyncGeminiChat:
    ...
    @property
    def completions(self) -> _AsyncGeminiChatCompletions:
        return _AsyncGeminiChatCompletions(self._transport)
    ...
    async def stream_generate_content(
        ...
        **extra: Any,
        ...
        if cached_content is not None:
            body["cachedContent"] = cached_content
        body.update(extra)
        return await self._transport.request("POST", f"/v1beta/models/{model}:streamGenerateContent", json=body)
