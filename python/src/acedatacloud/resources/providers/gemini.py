...
GeminiModelGeneratecontentModel = Literal[
    "gemini-3.7-flash",
    "gemini-3.6-flash",
    "gemini-3.5-flash",
    "gemini-3.5-flash-lite",
...
GeminiModelStreamgeneratecontentModel = Literal[
    "gemini-3.7-flash",
    "gemini-3.6-flash",
    "gemini-3.5-flash",
    "gemini-3.5-flash-lite",
...
class Gemini:
    ...
    def model_generatecontent(
        ...
        *,
        ...
        model: GeminiModelGeneratecontentModel,
        ...
        **extra: Any,
        ...
        path = path.replace("{model}", quote(str(model), safe=""))
        body: dict[str, Any] = {}
        ...
        if callback_url is not None:
            body["callback_url"] = callback_url
        return self._transport.request("POST", path, json=body)

    def model_streamgeneratecontent(
        self,
        *,
        contents: list[dict[str, Any]],
        model: GeminiModelStreamgeneratecontentModel,
        systemInstruction: dict[str, Any] | None = None,
        generationConfig: dict[str, Any] | None = None,
        tools: list[dict[str, Any]] | None = None,
        toolConfig: dict[str, Any] | None = None,
        safetySettings: list[dict[str, Any]] | None = None,
        alt: Literal["sse"] | None = None,
        callback_url: str | None = None,
        **extra: Any,
    ) -> dict[str, Any]:
        ...
        if alt is not None:
            params["alt"] = alt
        return self._transport.request("POST", path, json=body, params=params)

    def generate(
        self,
        *,
        prompt: str,
        model: Literal["omni-flash"] | None = None,
...
class AsyncGemini:
    ...
    async def model_generatecontent(
        ...
        **extra: Any,
        ...
        if callback_url is not None:
            body["callback_url"] = callback_url
        return await self._transport.request("POST", path, json=body)
    ...
    async def model_streamgeneratecontent(
        ...
        **extra: Any,
        ...
        if alt is not None:
            params["alt"] = alt
        return await self._transport.request("POST", path, json=body, params=params)
