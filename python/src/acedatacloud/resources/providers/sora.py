...
SoraOrientation = Literal["landscape", "portrait"]
SoraSize = Literal["small", "large", "720x1280", "1280x720", "1024x1792", "1792x1024"]
SoraVersion = Literal["1.0", "2.0"]
...
class Sora:
    ...
    def generate(
        ...
        *,
        ...
        orientation: SoraOrientation | None = None,
        size: SoraSize | None = None,
        character_url: str | None = None,
        character_start: int | None = None,
        character_end: int | None = None,
        image_urls: list[str] | None = None,
        version: SoraVersion | None = None,
