...
class Minimax:
    ...
    def generate(
        ...
        *,
        prompt: str,
        model: Literal["minimax-h3"] | None = None,
        image_urls: list[str] | None = None,
        audio_urls: list[str] | None = None,
        resolution: Literal["768P", "2K"] | None = None,
        ratio: Literal["16:9", "9:16"] | None = None,
        ...
        **extra: Any,
        ...
        body["resolution"] = resolution if resolution is not None else "2K"
        body["ratio"] = ratio if ratio is not None else "16:9"
        body["duration"] = duration if duration is not None else 4
        body["aigc_watermark"] = aigc_watermark if aigc_watermark is not None else False
        body.update(extra)
