...
FishAudioMp3Bitrate = Literal[64, 128, 192]


def _add_optional_fields(body: dict[str, Any], **values: Any) -> None:
...
class Audio:
    ...
    def generate(
        ...
        *,
        ...
        format: FishAudioFormat | str | None = None,
        sample_rate: int | None = None,
        mp3_bitrate: FishAudioMp3Bitrate | int | None = None,
        opus_bitrate: int | None = None,
        latency: FishAudioLatency | str | None = None,
