...
class AiChat2:
    ...
    def chat(
        ...
        **kwargs: Any,
        ...
        body: dict[str, Any] = {"action": "chat", "model": model, **kwargs}
    ...
    def retrieve(
        ...
        **kwargs: Any,
        ...
        return self._transport.request(
            "POST", "/aichat2/conversations", json={"action": "retrieve", "id": id, **kwargs}
        )
    ...
    def update(
        ...
        **kwargs: Any,
        ...
        body: dict[str, Any] = {"action": "update", "id": id, **kwargs}
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        return self._transport.request(
            "POST", "/aichat2/conversations", json={"action": "delete", "id": id, **kwargs}
        )


class AsyncAiChat2:
    """Async AI Chat 2 client."""
