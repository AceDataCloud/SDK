...
def test_minimax_submits_the_documented_video_request(client):
    transport = Mock()
...
def test_minimax_rejects_an_out_of_range_duration(client):
    with pytest.raises(ValueError, match="duration must be between 4 and 15 seconds"):
